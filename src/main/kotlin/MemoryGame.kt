...
* UC: PROGRAMAÇÃO
* DOCENTE: PAULA GRAÇA
* 1.º TRABALHO DE GRUPO
*
* GRUPO 1
* Micaela Macatrão, n.º 39734
* João Marques, n.º 49212
* Noemi Ferreira, n.º 49226
*
* 31 DE OUTUBRO DE 2022
 */

const val SYMBOLS = "#%XO&"
...
fun isValidPositions(p1: Int, p2:Int, places: List<Char>): Boolean =
    p1 != p2 && p1 in places.indices && p2 in places.indices && places[p1] == '_' && places[p2] == '_'
...
fun List<Char>.turnPlaces(p1: Int, p2: Int, pairs: List<Char>): List<Char> =
    List(this.size) { idx ->
        if (idx == p1) pairs[p1] else if (idx == p2) pairs[p2] else this[idx]}
